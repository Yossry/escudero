...
class StockCardDetailsReportXls(models.AbstractModel):
    ...
    def create_xlsx_report(self, docids, data):
        _logger.warning("---------------------------------------")
        _logger.warning("Enters xlsx create")
        _logger.warning("---------------------------------------")
        objs = self._get_objs_for_report(docids, data)
        file_data = BytesIO()
        workbook = xlsxwriter.Workbook(file_data, self.get_workbook_options())
        _logger.warning("---------------------------------------")
        _logger.warning("Enters xlsx generation")
        _logger.warning("---------------------------------------")
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        _logger.warning("---------------------------------------")
        _logger.warning("Report formats")
        _logger.warning("---------------------------------------")
    ...
    #        index += 1
        ...
        _logger.warning("---------------------------------------")
        _logger.warning(len(data['lines']))
        _logger.warning("---------------------------------------")
        ...
        for categ in data['lines']:
            ...
            if not deb_print:
                _logger.warning("---------------------------------------")
                _logger.warning(len(categ['lines']))
                _logger.warning("---------------------------------------")
                deb_print = True
            for line in categ['lines']:
                ...
                if not deb_print2:
                    _logger.warning("---------------------------------------")
                    _logger.warning(len(line['lines']))
                    _logger.warning("---------------------------------------")
                    deb_print2 = True
